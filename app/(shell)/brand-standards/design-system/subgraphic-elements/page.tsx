      ...
      <section className="px-16 py-12 max-w-5xl space-y-14">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start mb-8">
            ...
            <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/brand-standards/03-design-system/04-subgraphic-elements/page-24.png`} alt="Wave Graphic introduction — full annotated diagram showing the wave form derived from the Scripps symbol" className="w-full h-auto object-contain" />
          </div>

          <h3 className="text-lg font-semibold text-gray-900 mb-4">Wave Graphic Compositions</h3>
          <div className="grid grid-cols-2 gap-4 mb-6">
            <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/brand-standards/03-design-system/04-subgraphic-elements/page-25a.png`} alt="Wave Graphic compositions — 8 thumbnail variations in medium and large sizes" className="w-full h-auto object-contain border border-gray-100 rounded" />
            <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/brand-standards/03-design-system/04-subgraphic-elements/page-25b.png`} alt="Wave Graphic compositions — horizontal banner format" className="w-full h-auto object-contain border border-gray-100 rounded" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start mb-4">
            ...
            <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/brand-standards/03-design-system/04-subgraphic-elements/page-26.png`} alt="Wave Graphic cropping guidelines — correct vs. incorrect crop examples" className="w-full h-auto object-contain" />
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-14">
          ...
          <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/brand-standards/03-design-system/04-subgraphic-elements/page-27.png`} alt="Print wave palette table — 8 named color schemes at 100/75/50% tints, plus 3 no-image palettes" className="w-full h-auto object-contain mb-6 border border-gray-100 rounded" />
        ...
        <div className="border-t border-gray-100 pt-14">
          ...
          <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/brand-standards/03-design-system/04-subgraphic-elements/page-28.png`} alt="Digital wave palette table — same 8 named palettes at enhanced digital saturation" className="w-full h-auto object-contain mb-5 border border-gray-100 rounded" />
        ...
        <div className="border-t border-gray-100 pt-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start mb-6">
            ...
            <img src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/brand-standards/03-design-system/04-subgraphic-elements/page-29.png`} alt="Veil Column color swatches — four options showing print fill range, web fill range, and multiply/opacity effect" className="w-full h-auto object-contain" />
          </div>
          <div className="overflow-x-auto rounded-lg border border-gray-200">
            <table className="w-full text-sm text-left">
              <thead className="bg-gray-50 border-b border-gray-200">
