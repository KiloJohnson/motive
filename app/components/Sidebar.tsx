...
const applicationNav: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Application Shells", href: "/application/blocks/application-shells" },
      ...
      { label: "Dashboard Footers", href: "/application/blocks/dashboard-footers" },
      { label: "Advanced Tables", href: "/application/blocks/advanced-tables" },
      { label: "Create Forms", href: "/application/blocks/create-forms" },
      { label: "Create Modals", href: "/application/blocks/create-modals" },
      { label: "Create Drawers", href: "/application/blocks/create-drawers" },
      { label: "Read Drawers", href: "/application/blocks/read-drawers" },
      { label: "Read Modals", href: "/application/blocks/read-modals" },
      { label: "Read Sections", href: "/application/blocks/read-sections" },
      { label: "Update Forms", href: "/application/blocks/update-forms" },
      { label: "Update Modals", href: "/application/blocks/update-modals" },
      { label: "Update Drawers", href: "/application/blocks/update-drawers" },
      { label: "Delete Confirm", href: "/application/blocks/delete-confirm" },
      { label: "Success Messages", href: "/application/blocks/success-message" },
      { label: "Dropdown Filters", href: "/application/blocks/dropdown-filters" },
      { label: "Faceted Search Drawers", href: "/application/blocks/faceted-search-drawers" },
      { label: "Faceted Search Modals", href: "/application/blocks/faceted-search-modals" },
    ],
  },
  {
    section: "Dashboards",
