...
const applicationNav: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Badge", href: "/application/components/badge", stub: true },
      { label: "Alert", href: "/application/components/alert", stub: true },
      { label: "Modal", href: "/application/components/modal", stub: true },
      { label: "Dropdown", href: "/application/components/dropdown", stub: true },
      { label: "Tabs", href: "/application/components/tabs", stub: true },
      { label: "Avatar", href: "/application/components/avatar", stub: true },
      { label: "Spinner", href: "/application/components/spinner", stub: true },
      { label: "Toast", href: "/application/components/toast", stub: true },
      { label: "Tooltip", href: "/application/components/tooltip", stub: true },
      { label: "Progress", href: "/application/components/progress", stub: true },
    ],
  },
];
