...
export default function AdminInCallPage() {
  return (
    <PreviewShell title="In Call" variant="admin">
      <div className="relative flex h-full w-full flex-col items-center justify-center bg-gray-50 px-4 dark:bg-gray-900">
        ...
        <div className="relative mb-10 flex w-full flex-col items-center justify-center">
          ...
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400">01:47</p>
        </div>

        {/* Call controls */}
        <div className="mx-auto grid w-full max-w-64 grid-cols-3 items-center justify-center gap-4 px-4 lg:flex lg:max-w-none">
          ...
          <div className="relative group/speaker">
            ...
            <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity group-hover/speaker:opacity-100 dark:bg-gray-700">
              Enable speaker
            </div>
          </div>
          ...
          <div className="relative group/video">
            ...
            <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity group-hover/video:opacity-100 dark:bg-gray-700">
              Video call
            </div>
          </div>
          ...
          <div className="relative group/mute">
            ...
            <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity group-hover/mute:opacity-100 dark:bg-gray-700">
              Mute audio
            </div>
          </div>
          ...
          <div className="relative group/participants">
            ...
            <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity group-hover/participants:opacity-100 dark:bg-gray-700">
              Invite others
            </div>
          </div>

          {/* End call */}
          <div className="relative group/endcall">
            <button
              type="button"
            ...
            <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity group-hover/endcall:opacity-100 dark:bg-gray-700">
              End call
            </div>
          </div>

          {/* Dial number (mobile only) */}
          <div className="relative group/dial lg:hidden">
            <button
              type="button"
              className="group flex h-16 w-16 items-center justify-center rounded-full border border-gray-100 bg-white hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
            ...
            <div className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity group-hover/dial:opacity-100 dark:bg-gray-700">
              Dial number
            </div>
          </div>
