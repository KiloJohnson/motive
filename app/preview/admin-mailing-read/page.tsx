...
function MailDetailsDropdown({ open }: { open: boolean }) {
  if (!open) return null;
  return (
    <div className="absolute left-0 top-full z-50 w-[360px] rounded bg-white p-4 shadow dark:bg-gray-700 mt-1">
      <ul className="space-y-2 text-sm font-normal">
        ...
        <li className="flex items-center text-gray-500 dark:text-gray-400">
          ...
          <time className="ms-1 text-gray-900 dark:text-gray-400" dateTime="2025-02-06 10:19">
            Feb 6, 2025, 10:19AM
          </time>
        </li>
        <li className="flex items-center text-gray-500 dark:text-gray-400">
        ...
        <li className="flex items-start text-gray-500 dark:text-gray-400">
          <div className="w-16 shrink-0">Security:</div>
...
function MoreActionsDropdown({ open }: { open: boolean }) {
  if (!open) return null;
  return (
    <div className="absolute right-0 top-full z-50 w-60 divide-y divide-gray-100 rounded bg-white shadow dark:divide-gray-600 dark:bg-gray-700 mt-1">
      <ul className="p-2 text-sm font-medium text-gray-500 dark:text-gray-400">
        <li>
          <button className="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
            {/* label icon */}
...
export default function AdminMailingReadPage() {
  const [detailsOpen, setDetailsOpen] = useState(false);
  const [moreOpen, setMoreOpen] = useState(false);

  return (
    <PreviewShell variant="admin" title="Mailing — Read">
      <div className="flex h-full flex-col overflow-hidden bg-white dark:bg-gray-800">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="flex items-center">
            ...
            <div className="pe-3">
              <input
                id="checkbox-all"
                type="checkbox"
                className="h-4 w-4 rounded-sm border-gray-300 bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600"
              />
            ...
            <div className="flex space-x-1 px-0 sm:px-2">
              ...
              <button
                ...
                className="hidden cursor-pointer justify-center rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white sm:inline-flex"
              >
                <svg className="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative">
                ...
                <MoreActionsDropdown open={moreOpen} />
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-1 sm:space-y-0">
            <span className="me-4 hidden text-sm text-gray-500 dark:text-gray-400 sm:flex">
              Show{" "}
              <span className="mx-1 font-semibold text-gray-900 dark:text-white">1-25</span> of{" "}
        ...
        <div className="flex-1 overflow-y-auto p-4 lg:px-8">
          ...
          {/* Subject + print/new-window actions */}
          <div className="mb-4 items-center justify-between border-b border-gray-200 pb-4 dark:border-gray-800">
            <div className="mb-4 flex items-center justify-between gap-4 border-b border-gray-200 pb-4 dark:border-gray-800">
              <h2 className="text-base font-medium text-gray-900 dark:text-white sm:mb-1.5 sm:flex sm:text-xl sm:leading-none">
                Inquiry about design services{" "}
                <span className="me-2 ms-3 hidden rounded bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300 sm:flex">
                  External
                </span>
              </h2>
            ...
            <div className="flex w-full items-center justify-between">
              {/* Avatar + sender name + details toggle */}
              <div className="flex items-center gap-4">
                ...
                <div className="font-semibold dark:text-white">
                  ...
                  <div className="relative">
                    ...
                    <MailDetailsDropdown open={detailsOpen} />
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <p className="me-4 hidden text-xs text-gray-500 dark:text-gray-400 sm:flex sm:text-sm">
                  Mon,{" "}
                  <time dateTime="2025-07-31 15:20">Jul 31, 3:20 PM</time>{" "}
                  (2 hours ago)
                </p>
                <button
          ...
          <article>
            ...
            <p className="mt-6 text-gray-500 dark:text-gray-400">
              I hope this email finds you well. My name is Jospeh McFallen, and I am reaching out to inquire about
              the design services offered by your esteemed company. I came across your portfolio and was truly
              impressed by the innovative and captivating designs showcased.
            </p>

            <p className="mt-6 text-gray-500 dark:text-gray-400">
              I am currently in the process of launching a Flowbite APP and believe that a distinctive and creative
              design is essential for setting the right tone and establishing a strong brand presence. Your expertise
              in this field caught my attention, and I am keen to explore the possibility of collaborating with your
              talented team.
            </p>

            <p className="mb-4 mt-6 text-gray-500 dark:text-gray-400">
              Here are some specific points I would like to discuss:
            </p>

            <ol className="list-inside list-decimal space-y-4 text-gray-500 dark:text-gray-400">
              <li>
                <span className="font-medium text-gray-900 dark:text-white">Brand Identity:</span>{" "}
                I am interested in creating a unique brand identity that resonates with our target audience. This
                includes logo design, color palette selection, and other visual elements that can effectively
                communicate our mission and values.
              </li>
              <li>
                <span className="font-medium text-gray-900 dark:text-white">Website Design:</span>{" "}
                As our digital storefront, the website needs to be user-friendly, visually engaging, and reflective
                of our brand identity. I would like to explore your approach to web design and understand how we can
                create an immersive online experience for our visitors.
              </li>
              <li>
                <span className="font-medium text-gray-900 dark:text-white">Print Collateral:</span>{" "}
                We also require various print materials, such as business cards, brochures, and promotional
                materials. I would love to see examples of your print design work and discuss how we can make a
                lasting impact through these materials.
              </li>
              <li>
                <span className="font-medium text-gray-900 dark:text-white">Packaging Design:</span>{" "}
                Since our product(s) will be an integral part of our brand, we aim to have packaging that is not
                only aesthetically pleasing but also functional and environmentally friendly. I am curious to know
                about your experience in creating standout packaging designs.
              </li>
              <li>
                <span className="font-medium text-gray-900 dark:text-white">Packaging Design:</span>{" "}
                Since our product(s) will be an integral part of our brand, we aim to have packaging that is not
              ...
              <li>
                <span className="font-medium text-gray-900 dark:text-white">Timeline and Pricing:</span>{" "}
                Understanding the timeline and cost of your services is crucial for our planning process. I would
                appreciate it if you could provide some insights into your typical project timelines and your
                pricing structure.
              </li>
            </ol>

            <p className="mt-6 text-gray-500 dark:text-gray-400">
              I am eager to explore the potential of working together and believe that your creative vision aligns
              perfectly with our project goals. Your portfolio speaks volumes about your talent, and I am excited
              about the prospect of bringing fresh, imaginative ideas to life with your team.
            </p>

            <p className="mt-6 text-gray-500 dark:text-gray-400">
              Please let me know if you would be available for a brief call or meeting to further discuss our
              requirements and explore the possibilities of collaboration. I am confident that together, we can
              create something exceptional that leaves a lasting impression on our audience.
            </p>
        ...
        <div className="mt-2 mb-4 flex items-center space-x-4 px-4 lg:px-8">
          {/* Reply */}
          <button className="inline-flex items-center rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-[#1A56DB] focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">
